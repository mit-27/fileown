...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-3 z-50 flex items-center justify-between gap-8 rounded-lg border px-1.5 py-2 bg-muted/70 md:top-3 mx-auto w-full max-w-4xl ">
        <div className="flex items-center gap-6">
            <div className="ml-3 flex items-center gap-3 cursor-pointer">
                <Link href="/" className="text-medium text-primary font-bold cursor-pointer">Fileown</Link>
            </div>
            <div
            className={cn(
