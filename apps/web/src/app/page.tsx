    ...
    >
      ...
      <span className="group-hover:underline">→</span>
        ...
        <div className="mt-5">
          ...
          className="group p-4 px-5 pb-3.5 bg-gradient-to-br from-[#4a89c4]/80 to-[#4a89c4] font-semibold text-white rounded leading-none flex items-center justify-center hover:bg-[#4a89c4] transition-colors duration-200 ease-in-out max-w-max text-balance"
          >
            Get Started
          </a>
